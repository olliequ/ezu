"""
URL configuration for quarm_oliver_ezu project.
...
"""Here's the specific URLs for this app. We have the URL patterns in a list,
each detailed in a path constructor. The first argument is the URL, the second is 
the view to call to function for the URL as a response, and lastly we give a unique
name for this URL pattern. If a specifier is passed in, the view will receive it."""
